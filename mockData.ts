...
export const mockVacancies: Vacancy[] = [
  {
    ...
    experienceYears: 5,
    requirements: 'Опыт работы с React 18+, TypeScript, Tailwind CSS. Требуется минимум 5 лет опыта коммерческой разработки. Знание современных практик фронтенд-разработки, умение работать с REST API. Опыт проектирования архитектуры сложных SPA приложений. Понимание принципов SSR и оптимизации производительности.',
  ...
  },
  {
    ...
    experienceYears: 3,
    requirements: 'Опыт работы с Node.js, PostgreSQL, Redis. Требуется минимум 3 года коммерческой разработки. Знание принципов построения REST API и микросервисной архитектуры. Опыт работы с реляционными базами данных, написание эффективных SQL-запросов. Понимание асинхронного программирования и работы с очередями задач.',
