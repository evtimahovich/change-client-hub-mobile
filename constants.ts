...
export const STATUS_COLORS: Record<CandidateStatus, { bg: string, text: string, border: string }> = {
  ...
  [CandidateStatus.INTERNSHIP]: { bg: 'bg-cyan-50', text: 'text-cyan-600', border: 'border-cyan-100' },
  ...
  [CandidateStatus.RESERVE]: { bg: 'bg-orange-50', text: 'text-orange-600', border: 'border-orange-100' },
  [CandidateStatus.FIRED]: { bg: 'bg-zinc-100', text: 'text-zinc-600', border: 'border-zinc-200' },
